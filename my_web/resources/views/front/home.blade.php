    ...
    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="false">
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <picture>
                    <source media="(max-width: 799px)" srcset="{{ asset('front-assets/images/no_image.png') }}" />
                    <source media="(min-width: 800px)" srcset="{{ asset('front-assets/images/default-150x150.png') }}" />
                    <img src="{{ asset('front-assets/images/no_image.png') }}" alt="" />
                </picture>
            ...
            <div class="carousel-item">
                <picture>
                    ...
                    <source media="(min-width: 800px)" srcset="{{ asset('front-assets/images/no_image.png') }}" />
