		...
		<div class="container">
			<div class="row align-items-center py-3 d-none d-lg-flex justify-content-between">
				<div class="col-lg-4 logo">
					<a href="{{ route('front.store') }}" class="text-decoration-none">
						<span class="h1 text-uppercase text-primary bg-dark px-2">STORE</span>
					</a>
				</div>
				...
				<div class="row">
					<div class="col-12 mt-3">
						<div class="copy-right text-center">
							<p>© Copyright 2024 Store Online. All Rights Reserved</p>
						</div>
					</div>
				</div>
			</div>
