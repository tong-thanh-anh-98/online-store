        ...
        <div class="container">
            <div class="light-font">
                <ol class="breadcrumb primary-color mb-0">
                    ...
                    <li class="breadcrumb-item"><a class="white-text" href="{{ route('front.store') }}">Store</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body d-flex justify-content-center align-items-center">
                                <h4>No products have been added to the cart yet.</h4>
                            </div>
                        </div>
                    </div>
                @endif
...
@section('customJs')
    <script>
        $('.add').click(function() {
            const qtyElement = $(this).parent().prev();
            const qtyValue = parseInt(qtyElement.val());
            if (qtyValue < 10) {
                qtyElement.val(qtyValue + 1);

                const rowId = $(this).data('id');
                const newQty = qtyElement.val();
                updateCart(rowId, newQty);
            }            
        });

        $('.sub').click(function() {
            const qtyElement = $(this).parent().next(); 
            const qtyValue = parseInt(qtyElement.val());
            if (qtyValue > 1) {
                qtyElement.val(qtyValue - 1);
